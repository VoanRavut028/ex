...
```mermaid
gantt
    title Full-Stack Bootcamp Timeline (13 Weeks)
    dateFormat YYYY-MM-DD
    
    section Module 1: Fundamentals
    HTML, CSS, TailwindCSS    :m1w1, 2026-01-05, 1w
    JavaScript & DOM          :m1w2, after m1w1, 1w
    
    section Module 2: Frontend
    Vue.js Fundamentals       :m2w1, after m1w2, 2w
    Advanced Vue & State      :m2w2, after m2w1, 2w
    
    section Module 3: Backend
    REST API & Express        :m3w1, after m2w2, 2w
    MongoDB & Optimization    :m3w2, after m3w1, 2w
    
    section Module 4: DevOps
    CI/CD & GitHub Actions    :m4w1, after m3w2, 2w
    Deployment & Production   :m4w2, after m4w1, 1w
```
...
```mermaid
graph LR
    A[Week 1-2<br/>Fundamentals] --> B[Week 3-6<br/>Frontend]
    B --> C[Week 7-10<br/>Backend]
    C --> D[Week 11-13<br/>DevOps]
...
<div align="center">
  <table>
    ...
    <tr>
      ...
      <td align="center" style="padding: 10px;">
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postman/postman-original.svg" width="50" alt="REST API">
      </td>
      <td align="center" style="padding: 10px;">
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg" width="50" alt="VS Code">
      </td>
      <td align="center" style="padding: 10px;">
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/netlify/netlify-original.svg" width="50" alt="Netlify">
      </td>
    </tr>
  </table>
</div>
...
**Day 1 (Monday) - API Integration & Async Operations** | 1.5 hours | [📖 Lesson](ex/lessons/api.md) | [📝 Homework](modules/2-frontend/homeworks/w6d1-homework.md) | [🧩 Code](https://github.com/KimangKhenng/vue-w5) | [▶️ Video](https://drive.google.com/file/d/13luk4smF518EFys0c4Y1lyxXQF4RYcFO/view?usp=sharing)
